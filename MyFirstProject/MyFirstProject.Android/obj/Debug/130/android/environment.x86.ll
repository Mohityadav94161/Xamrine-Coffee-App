...
@__DSOCacheEntry_name.7 = internal constant [12 x i8] c"libsealc.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 11
	%struct.DSOCacheEntry {
		i64 2002674073, ; hash 0x775e6199, from name: libsealc
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
	...
	; 14
	%struct.DSOCacheEntry {
		i64 2436515190, ; hash 0x913a4576, from name: sealc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 21
	%struct.DSOCacheEntry {
		i64 3137843477, ; hash 0xbb07b115, from name: sealc
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 3634442578, ; hash 0xd8a13152, from name: libsealc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
