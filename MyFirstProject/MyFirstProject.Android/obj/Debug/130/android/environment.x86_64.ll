...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"37d967dd-b6a8-413a-a3a4-21a1feb35c77\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.myfirstproject\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [12 x i8] c"libsealc.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1519739171231991125, ; hash 0x151732b96c878555, from name: sealc
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
	...
	; 7
	%struct.DSOCacheEntry {
		i64 6547526977334504719, ; hash 0x5add7d18794f6d0f, from name: sealc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 21
	%struct.DSOCacheEntry {
		i64 12201562562971136907, ; hash 0xa954a8811e99738b, from name: libsealc
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 15200987924302484346, ; hash 0xd2f4c1fa970d537a, from name: libsealc.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
